...
<head>
    <title>Pedidos | Hello Stock</title>
...
<body>
    ...
    $query = ("SELECT cliente, produto, localidade, quantidade, data, status FROM relatorio_pedidos");
    // executa a query
        ...
        <div class="layoutcor">
            <div class="espacamentonome">
                <div class="layoutcor">
                             ...
                             <a href="../index.php"> <button  type="button" "margin-right: 15px" class="btn btn-primary" >Voltar </button> </a>
                            
                            <input type="button" class="btn btn-primary" value="Alterar"></input> 
                             
            
                <table>
                    <thead>
                        <tr class="layoutcor-head">
                            <th class="coluna1">Cliente</th>
                            <th class="coluna1">Produto</th>
                            <th class="coluna2">Localidade</th>
                            <th class="coluna3">Quantidade</th>
                            <th class="coluna4">Data</th>
                            <th class="coluna5">Status</th>
                        </tr>
                    </thead>
                    <?php while($exibe = mysqli_fetch_array($dados)){ ?>

                    <form action="atualizar_relatorio.php" method="post" enctype="multipart/form-data" name="form2"
                        id="form2">

                        <tbody>
                            <tr>
                                <td class="coluna1">
                                    <?php echo $exibe['cliente'];?>
                                </td>
                                <td class="coluna1">
                                    <?php echo $exibe['produto'];?>
                                </td>
                                <td class="coluna2">
                                    <?php echo $exibe['localidade'];?>
                                </td>
                                <td class="coluna3">
                                    <?php echo $exibe['quantidade'];?>
                                </td>
                                <td class="coluna4">
                                    <?php echo $exibe['data'];?>
                                </td>
                                <?php if ($exibe['status'] == "Aguardando Pagamento"){ ?>
                                <td><select name="mudarpedido1">
                                ...
                                <?php }elseif ($exibe['status'] == "Pagamento Aprovado"){ ?>
                                <td><select name="mudarpedido2">
                                ...
                                <?php }elseif ($exibe['status'] == "Produto Enviado"){ ?>
                                <td><select name="mudarpedido3">
                                        <option value="Aguardando Pagamento">Aguardando Pagamento</option>
                                        <option value="Produto Aprovado">Pagamento Aprovado</option>
                                        <option value="*" selected>
                                            <?php echo $exibe['status']; ?>
                                        </option>
                                    </select></td>
                ...
                <div class="paginacao">
                    <nav aria-label="Navegação de página exemplo">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link" href="pedidos.php">1</a></li>
