...
<head>
    <title>Produtos Minimos | Hello Stock</title>
...
<body>
    ...
    include('../../config.php');
        ...
        $query = ("SELECT pro_cod, pro_nome, pro_valorpago, pro_quantidade FROM produto WHERE pro_quantidade < 10");
        // executa a query
                ...
                <table>
                    <thead>
                        <tr class="layoutcor-head">
                            <th class="coluna1">Codigo</th>
                            <th class="coluna1">Produto</th>
                            <th class="coluna2">Valor Pago</th>
                            <th class="coluna3">Quantidade Restante</th>
                        </tr>
                    </thead>
                    ...
                    <form action="atualizar_relatorio.php" method="post" enctype="multipart/form-data" name="form2"
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                if($exibe['pro_quantidade'] < 10) {
                            
                            ?>

                                <td class="coluna1">
                                    <?php echo $exibe['pro_cod'];?>
                                </td>
                                <td class="coluna1">
                                    <?php echo $exibe['pro_nome'];?>
                                </td>
                                <td class="coluna2">
                                   R$ <?php echo $exibe['pro_valorpago'];?>
                                </td>
                                <td class="coluna3">
                                    <?php echo $exibe['pro_quantidade']; ?>
                                </td>
                ...
                <div class="paginacao">
                    <nav aria-label="Navegação de página exemplo">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link" href="produtos_minimos.php">1</a></li>
