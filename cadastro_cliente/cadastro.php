...
<div class="container-fluid">
      <form action="..\adciona_imagem.php" method="post" class="row col-sm-4 col-sm-offset-4 ">
        ...
        <div class="form-group">
          <label>Senha</label>
          <input type="password" required class="form-control" name="senha"  placeholder="Digite sua Senha" required>
        </div>

        <div class="form-group">
          <label>E-mail</label>
          <input type="e-mail" class="form-control" name="email" id="e-nmail" required placeholder="Digite seu e-mail">
        </div>
