<?php  
function promocao($exibe , $valorcomdesconto){
  $valorcomdesconto = $exibe['pro_valorvenda'] -= 20;
 return $exibe;
}
?>
...
<!DOCTYPE html>
    ...
    <html lang="pt-br">
        ...
        <Head>
            ...
            <meta charset="utf-8">
            <title>Promoções | Hello Stock</title>
        ...
        <body>
          ...
          include 'cabecalho.html';
            ...
            $consulta = $connection->query("SELECT pro_cod,imagens,pro_nome,pro_valorvenda,pro_quantidade,pro_valordesconto FROM produto WHERE pro_promocoes = 'S'");
...
<div><h4 class="text-center">
 <b style="color: #f0ad4e ;"><?php echo 'R$ ' .  number_format($exibe['pro_valordesconto'],2,',','.' )?></b>
  <span style="text-decoration: line-through ;"><?php echo 'R$ ' .  number_format($exibe['pro_valorvenda'],2,',','.' )?></span> 
